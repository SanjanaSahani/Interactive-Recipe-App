            ...
            {questions.map((item, index) => (
                <div key={index} className="border-b border-gray-200 ">
                    <button
                        ...
                        className={`flex justify-between w-full p-4 focus:outline-none bg-slate-100 text-slate-400 border-l-4 border-green-700 mb-4 ${openIndexes.includes(index) ? 'bg-green-800 text-white' : ''}`}
                    >
