      ...
      <div className='flex p-8 ml-[13%]'>
        ...
        <ul className='flex p-5 gap-2 ml-[9%] text-slate-600 font-semibold cursor-pointer'>
          ...
          <li className='mt-2'>
            ...
            {dropdownOpen && (
              <ul className="absolute mt-2 py-2 bg-white border shadow-lg" style={{ zIndex: 1 }}>
                <li>
          ...
          <li className='mt-2'>
            ...
            {dropdownOpenn && (
              <ul className="absolute mt-2 py-2 pl-6 pr-4 bg-white border shadow-lg " style={{ zIndex: 1 }}>
                <li>
                  <NavLink to='/' className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-green-600'>
                    Home
                  </NavLink>
